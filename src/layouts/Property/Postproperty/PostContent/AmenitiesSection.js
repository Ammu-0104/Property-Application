...
import CommunityHall from "../../../../assets/Icons/amacommunityhall.svg";
import { usePropertyContext } from "../Mycontext";
import AmenitiesFlow from "./PropertyFlow/PlotAmenetiesFlow";
import OfcAmaFlow from "./PropertyFlow/OfcAmaFlow";
import RetailAmaFlow from "./PropertyFlow/RetailAmaFlow";
import WarehouseAmaFlow from "./PropertyFlow/WarehouseAmaFlow";
import HotelsAmaFlow from "./PropertyFlow/HotelsAmaFlow";
import AgricultureAmaFlow from "./PropertyFlow/AgriAmaFlow";
import ManufacturingAma from "./PropertyFlow/ManufatureAma";
import FilmAma from "./PropertyFlow/FilmAma";
  ...
  return (
    <div>
      <div className="amaenities_cont">
        <h3 className="basic_heading m-0">Amenities/unique features</h3>
          ...
          selectedProperty !== "Film / Production Studio" && (
            <div>
              ...
              <div className="amanity_furniture">
                ...
                <div
                  className="ama_cont me-3"
                  onClick={() => handleAmenityClick("Community Hall")}
                  style={getAmenitiesButtonStyle("Community Hall")}
                >
                  <div>
                    <img src={CommunityHall} alt="dining table" />
                  </div>
                  <div>
        ...
        {selectedProperty === "Plot / Land" && <AmenitiesFlow />}
        {(selectedProperty === "Office Space" ||
          selectedProperty === "Research Parks / Technology") && <OfcAmaFlow />}
        {(selectedProperty === "Retail Spaces" ||
          selectedProperty === "Show room" ||
          selectedProperty === "ATM Space") && <RetailAmaFlow />}
        {(selectedProperty === "Ware house" ||
          selectedProperty === "Mixed-Use / Special Purpose") && (
          <WarehouseAmaFlow />
        )}
