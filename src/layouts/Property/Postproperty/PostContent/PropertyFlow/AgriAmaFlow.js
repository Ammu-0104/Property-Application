...
import CentralAirConditioning from "../../../../../assets/Icons/ofcamacenterfan.svg";
import OxygenDuct from "../../../../../assets/Icons/ofcamaoxgen.svg";

const AgricultureAmaFlow = () => {
    ...
    <div>
      <div className="amanity_furniture pb-5">
        ...
        >
          ...
          <div>
            <p className="m-0 text-center ama_space">
...
export default AgricultureAmaFlow;
