...
//     selectedParking: "", 
//     selectedOpenParking: null,
//     selectedTotalFloors: "",
//     selectedDirection: "",
//     selectedPropertyFloor: "",
    ...
    <div>
      <div className="propert_Areadetails ofc_pro">
        ...
        <div className="pro_otherromms">
          ...
          <div className="d-flex mb-2 retail">
            
            <button
              className="loc_bhkopt d-flex justify-content-center align-items-center ofc_park"
              style={getFurnitureButtonStyle("Mall")}
              onClick={() => handleFurnitureClick("Mall")}
            >
              Mall
            </button>
            ...
            <button
              className="loc_bhkopt d-flex justify-content-center align-items-center ofc_park"
              style={getFurnitureButtonStyle("Commercial Project")}
              onClick={() => handleFurnitureClick("Commercial Project")}
            >
              Commercial Project
            </button>
            <button
              className="loc_bhkopt d-flex justify-content-center align-items-center ofc_park"
              style={getFurnitureButtonStyle("Residential Project")}
              onClick={() => handleFurnitureClick("Residential Project")}
            >
              Residential Project
            </button>
            <button
              className="loc_bhkopt d-flex justify-content-center align-items-center ofc_park"
              style={getFurnitureButtonStyle("Retail Complex/Building")}
              onClick={() => handleFurnitureClick("Retail Complex/Building")}
            >
              Retail Complex/Building
            </button>
            <button
              className="loc_bhkopt d-flex justify-content-center align-items-center ofc_park"
              style={getFurnitureButtonStyle("Market/High/Street")}
              onClick={() => handleFurnitureClick("Market/High/Street")}
            >
              Market/High/Street
            </button>
            <button
