    ...
    <div>
      ...
      <div className="pro_reserved">
        ...
        <div>
          ...
          <div>
            <h6 className="basic_looking pb-3 m-0">
              No of open sides<span className="loc_ast">*</span>
            </h6>
            <button
              className="Loc_one"
            ...
            <button
              className="Loc_one"
              style={getOpenParkingButtonStyle(4)}
              onClick={() => handleOpenParkingClick(4)}
            >
              4
            </button>
          </div>
